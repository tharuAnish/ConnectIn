...
const PostInput = ({ user }: { user: any }) => {
  ...
  return (
    <div className="bg-white p-4 pb-2 my-2 md:m-0 border border-gray-300 rounded-xl">
      <div className="flex items-center gap-3">
        ...
        <Input
          ...
          className="rounded-full focus-visible:ring-0 hover:bg-muted h-12 cursor-pointer"
      ...
      <div className="flex gap-1 mt-3">
        ...
        >
          ...
          <span className="text-gray-800 text-sm hidden md:block">Photo</span>
        </div>
        <div
          onClick={inputHandler}
        ...
        >
          ...
          <span className="text-gray-800 text-sm hidden md:block">Video</span>
        </div>
        <div
          onClick={inputHandler}
          className="flex-1 space-x-2 flex justify-center items-center  rounded py-2 hover:bg-muted cursor-pointer"
